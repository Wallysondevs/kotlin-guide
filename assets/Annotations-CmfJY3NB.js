...
<div class="callout callout-tip"><div class="callout-title">@OptIn</div><div>Anotações marcadas com <code>@RequiresOptIn</code> exigem que o consumidor escreva <code>@OptIn(ApiBeta::class)</code> ou <code>-opt-in=...</code>. É a forma idiomática de marcar APIs experimentais.</div></div>`}})]})}export{d as default};
