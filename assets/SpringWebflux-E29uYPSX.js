...
<div class="callout callout-tip"><div class="callout-title">Async paralelo</div><div>Para chamadas externas independentes: <code>coroutineScope { val a = async { servA() }; val b = async { servB() }; Resp(a.await(), b.await()) }</code>.</div></div>`}})]})}export{t as default};
