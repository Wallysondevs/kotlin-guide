export default function ClassesAbstratas() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Classes abstratas em Kotlin são marcadas com <code>abstract</code> e servem como base parcial para hierarquias: contêm estado, construtores e podem mesclar membros concretos com membros <code>abstract</code> (sem implementação) que subclasses devem prover.</p>
...
<div class="callout callout-tip"><div class="callout-title">Construtor secundário</div><div>Use <code>: super(...)</code> ou <code>: this(...)</code> para delegar. Em classe abstrata, isso permite múltiplas formas de criação preservando invariantes.</div></div>`}} />
    </article>
  );
}
