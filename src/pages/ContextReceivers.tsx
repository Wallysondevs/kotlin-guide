export default function ContextReceivers() {
    return (
      <article className="chapter max-w-3xl mx-auto px-6 py-10">
        <div className="text-xs text-muted-foreground mb-2 font-mono">Anotações e DSLs · avancado · 8 min</div>
        <h1>Context receivers (preview)</h1>
