export default function ExposedOrm() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Banco de dados · intermediario · 11 min</div>
      <h1>Exposed ORM</h1>
      <div dangerouslySetInnerHTML={{__html: `<p><strong>Exposed</strong> é o ORM oficial da JetBrains para Kotlin/JVM. Oferece duas APIs: uma <em>DSL</em> tipada que se parece com SQL, e uma camada <em>DAO</em> com entidades. Não usa anotações; tudo é Kotlin idiomático.</p>
...
<div class="callout callout-tip"><div class="callout-title">DSL ou DAO?</div><div>DSL é mais explícito e performático; DAO é mais conveniente para CRUD simples. Misture conforme a necessidade — eles compartilham o mesmo schema.</div></div>`}} />
    </article>
  );
}
