export default function Flows() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <h1>Flow básico</h1>
      <div dangerouslySetInnerHTML={{__html: `<p><code>Flow</code> é a abstração de stream <em>assíncrono</em> de <code>kotlinx.coroutines</code>. Representa uma sequência de valores produzidos ao longo do tempo, com <em>backpressure</em> embutida via suspensão. Pense em <code>Sequence</code> + <code>suspend</code>.</p>
...
<div class="callout callout-tip"><div class="callout-title">Teste de Flow</div><div>Use <code>turbine</code> (CashApp) ou as utilidades de <code>kotlinx-coroutines-test</code> para fazer asserts elemento-a-elemento de forma síncrona.</div></div>`}} />
    </article>
  );
}
