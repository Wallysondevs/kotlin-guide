...
<div class="callout callout-warn"><div class="callout-title">Não inline tudo</div><div>Marcar todas as funções como <code>inline</code> é antipadrão. Use quando há lambdas <em>e</em> a função é pequena <em>ou</em> você precisa de <code>reified</code>/return não-local.</div></div>`}} />
    </article>
  );
}
