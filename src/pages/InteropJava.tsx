export default function InteropJava() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Multiplataforma e avançado · intermediario · 10 min</div>
      <h1>Interop Java &lt;-&gt; Kotlin</h1>
