export default function InteropJs() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Multiplataforma e avançado · avancado · 8 min</div>
      <h1>Kotlin/JS interop</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Kotlin/JS compila Kotlin para JavaScript (ES5/ES2015) e roda em browser ou Node.js. A interoperabilidade com o ecossistema JS é feita via <code>external</code> declarations, o tipo <code>dynamic</code> e dependências npm declaradas no Gradle.</p>
...
<div class="callout callout-tip"><div class="callout-title">Dukat</div><div>O <em>Dukat</em> tentava gerar declarações Kotlin a partir de <code>.d.ts</code> automaticamente, mas foi descontinuado. Hoje a recomendação é escrever <code>external</code> manualmente, focando só no que você usa.</div></div>`}} />
    </article>
  );
}
