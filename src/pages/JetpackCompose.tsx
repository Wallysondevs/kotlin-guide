export default function JetpackCompose() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Android · intermediario · 12 min</div>
      <h1>Jetpack Compose básico</h1>
