export default function KotlinScript() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Build e tooling · intermediario · 7 min</div>
      <h1>Kotlin Script (.kts)</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Kotlin Script (extensão <code>.kts</code>) permite escrever programas Kotlin <em>sem</em> declarar <code>main()</code> nem classe — o arquivo inteiro vira o corpo de execução. É a base do <strong>Gradle Kotlin DSL</strong> e útil para automação, prototipagem e ferramentas internas.</p>
...
<div class="callout callout-tip"><div class="callout-title">Shebang</div><div>Com <code>#!/usr/bin/env kotlin</code> no topo e bit de execução, scripts <code>.main.kts</code> rodam como qualquer ferramenta Unix — com o bônus de tipos estáticos.</div></div>`}} />
    </article>
  );
}
