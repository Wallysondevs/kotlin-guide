export default function LetAlsoRunApply() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Null safety · intermediario · 11 min</div>
      <h1>let, also, run, apply, with</h1>
