export default function Mockk() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Testes · intermediario · 9 min</div>
      <h1>MockK</h1>
      <div dangerouslySetInnerHTML={{__html: `<p><strong>MockK</strong> é a biblioteca de mocking idiomática para Kotlin. Ao contrário de Mockito, suporta nativamente <code>final</code> classes (padrão de Kotlin), <code>object</code>, funções de extensão, suspend functions e construtores.</p>
...
<div class="callout callout-warn"><div class="callout-title">Não mocke o que você não possui</div><div>Mockar tipos de bibliotecas externas (especialmente <code>final</code> com lógica complexa) tende a quebrar em upgrades. Prefira <em>fakes</em> ou wrappers.</div></div>`}} />
    </article>
  );
}
