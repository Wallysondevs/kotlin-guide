export default function MongodbDriver() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Banco de dados · intermediario · 10 min</div>
      <h1>MongoDB driver Kotlin</h1>
