export default function NullSafety() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Null safety · iniciante · 9 min</div>
      <h1>Null safety</h1>
      <div dangerouslySetInnerHTML={{__html: `<p><em>Null safety</em> é o recurso mais celebrado de Kotlin: a distinção entre tipos que <strong>podem</strong> e <strong>não podem</strong> ser <code>null</code> é codificada no próprio sistema de tipos e verificada em tempo de compilação. O compilador recusa <code>NullPointerException</code> antes do código rodar.</p>
...
<div class="callout callout-tip"><div class="callout-title">Boa prática</div><div>Anote APIs Java consumidas com <code>@Nullable</code>/<code>@NonNull</code> (JSR-305 / JetBrains / AndroidX) — o Kotlin respeita e gera tipos corretos.</div></div>`}} />
    </article>
  );
}
