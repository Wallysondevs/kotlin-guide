export default function OperacoesFuncionais() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Coleções · intermediario · 11 min</div>
      <h1>Operações funcionais</h1>
