...
<div class="callout callout-tip"><div class="callout-title">Infix</div><div>Funções marcadas com <code>infix</code> (como <code>and</code>, <code>to</code>, <code>until</code>) leem como operadores: <code>1 to "a"</code>, <code>0 until 10</code>. Use com parcimônia em DSLs.</div></div>`}} />
    </article>
  );
}
