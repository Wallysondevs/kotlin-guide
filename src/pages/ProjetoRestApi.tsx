export default function ProjetoRestApi() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Projetos · avancado · 15 min</div>
      <h1>Projeto: REST API com Ktor</h1>
