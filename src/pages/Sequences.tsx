...
<div class="callout callout-tip"><div class="callout-title">Regra prática</div><div>Use <code>asSequence()</code> quando: (a) há &gt;3 operações encadeadas, (b) o dataset é grande, (c) o terminal pode parar cedo (<code>first</code>, <code>take</code>, <code>any</code>).</div></div>`}} />
    </article>
  );
}
