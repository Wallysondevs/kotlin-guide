export default function SpringValidation() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Spring Boot · intermediario · 8 min</div>
      <h1>Validation com Bean Validation</h1>
