export default function TypeSafeBuilders() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Anotações e DSLs · avancado · 12 min</div>
      <h1>Type-safe builders (DSL)</h1>
