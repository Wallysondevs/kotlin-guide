export default function ValueClass() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Funcional avançado · intermediario · 8 min</div>
      <h1>value class (inline class)</h1>
